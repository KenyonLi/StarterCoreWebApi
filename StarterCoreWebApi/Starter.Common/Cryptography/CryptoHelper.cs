...
namespace Starter.Common
{
    public static class CryptoHelper
    {
        ...
        /// 加密向量
        /// </summary>
        private static readonly string md5IV = "fdsjSDFLAC;DSFO!@$@#*(&$!@^@($*#(@054";
        /// <summary>
        /// 加密密钥
        /// </summary>
        private static readonly string key = "fdsjSDFLAC;DSFO!@$@#*(&$!@^@($*#(@054";
        /// <summary>
        /// 加密字符串
        /// </summary>
        /// <param name="strSource">要加密的字符串</param>
        /// <returns>加密后的字符串</returns>
        public static string DESEncrypt(this string strSource)
        {
        ...
        public static string DESDecrypt(this string strSource)
        {
            Alogrim objAlogrim = new Alogrim(Alogrim.SymmProvEnum.DES);
            objAlogrim.Key = key;
            objAlogrim.IV = md5IV;
    ...
    public class Alogrim
    {
        ...
        public string Decrypting(string Source)
        {
            ...
            byte[] bytIn = Convert.FromBase64String(Source.Replace(" ", "+"));
        ...
        public void Encrypting(Stream SourceStream, Stream EncryptorStream)
        {
            // 创建加密器
            ICryptoTransform objEncryptor = objCryptoService.CreateEncryptor();
        ...
        /// <returns>布尔值</returns>
        public void Decrypting(Stream EncryptorStream, Stream SourceStream)
        {
            // 创建加密器
